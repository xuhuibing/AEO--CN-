...
const questionBank = {
    advanced: {
        internal: [
            { q: '是否指定了海关业务联系人并保持有效沟通？', options: ['已指定并保持沟通', '已指定但沟通不充分', '未指定'] },
            { q: '法定代表人/关务负责人是否掌握进出口业务总体情况？', options: ['完全掌握', '基本掌握', '不了解'] },
            { q: '关务人员是否熟悉本岗位海关管理要求？', options: ['熟悉', '基本熟悉', '不熟悉'] },
            { q: '是否积极配合海关稽查/调查/核查工作？', options: ['积极配合', '基本配合', '配合不足'] },
            { q: '申报前是否对单证真实性/完整性进行内部复核？', options: ['双人复核制度完善', '单人复核', '无复核制度'] },
            { q: '进出口单证是否按规定归档保管？', options: ['规范归档', '基本规范', '不规范'] },
            { q: '是否有专门岗位对禁限货物进行审查？', options: ['有专门审查', '兼职审查', '未审查'] },
            { q: '信息系统是否覆盖生产经营主要环节并保存3年以上？', options: ['系统全覆盖且保存≥3年', '部分覆盖', '未覆盖'] },
            { q: '信息安全管理制度、防火墙/密码/备份措施是否到位？', options: ['到位', '基本到位', '不足'] },
            { q: '是否每年对进出口活动进行内部审计并形成档案？', options: ['每年审计并归档', '偶有开展', '未开展'] },
            { q: '发现的问题是否由法定代表人组织处置和改进？', options: ['法定代表人组织改进', '部门自行处理', '未处理'] }
        ],
        finance: [
            { q: '审计报告是否为无保留意见且按时报送海关？', options: ['无保留意见且按时报送', '保留意见', '否定意见/未报送'] },
            { q: '偿债能力指标（资产负债率/现金比率/流动比率等）是否达标？', options: ['2项及以上达标', '仅1项达标', '都不达标'] },
            { q: '盈利能力指标（净利润/营业利润率/毛利率等）是否达标？', options: ['2项及以上达标', '仅1项达标', '都不达标'] },
            { q: '是否存在进入解散程序或被宣告破产的情形？', options: ['不存在', '存在解散风险', '已被宣告破产'] }
        ],
        compliance: [
            { q: '海关注册登记信息是否与实际相符，2年内无不办理变更？', options: ['相符且无不办理', '存在未办变更', '信息不符'] },
            { q: '企业相关人员2年内是否因故意犯罪被刑事处罚？', options: ['无', '有已处理', '有未处理'] },
            { q: '1年内单次海关行政处罚金额是否超过5万元？', options: ['无处罚或未超标', '有超标处罚', '多次超标'] },
            { q: '1年内海关行政处罚次数和累计金额是否在规定范围内？', options: ['次数≤3次且≤10万元', '轻微超标', '严重超标'] },
            { q: '2年内是否有固废/出口管制违规处罚？', options: ['无', '有轻微', '有严重'] },
            { q: '1年内是否有进出口活动或与海关直接相关的业务？', options: ['有', '较少', '无'] },
            { q: '2年内有无超期未缴纳税款/罚款/违法所得？', options: ['无', '有已补缴', '有未缴纳'] },
            { q: '报关单查获率是否在标准范围内？', options: ['达标', '接近临界', '超标'] },
            { q: '1年内追征税款金额和次数是否在规定范围内？', options: ['达标', '接近超标', '超标'] },
            { q: '2年内是否委托了失信/严重失信企业办理报关？', options: ['未委托', '有但已整改', '有且未整改'] },
            { q: '2年内是否接受失信企业委托办理业务？', options: ['未接受', '有但已整改', '有且未整改'] },
            { q: '2年内是否被列入海关信用信息异常企业名录？', options: ['未被列入', '曾被列入已移出', '被列入'] },
            { q: '2年内是否被海关统计处置（虚增贸易等）？', options: ['无', '有但已处置', '有未处置'] },
            { q: '2年内是否向海关提供虚假情况或隐瞒事实？', options: ['无', '有但不严重', '有严重'] },
            { q: '2年内是否有抗拒阻碍海关执法情形？', options: ['无', '有轻微', '有严重'] },
            { q: '2年内是否有转移隐匿篡改毁弃资料情形？', options: ['无', '有但已纠正', '有未纠正'] },
            { q: '2年内是否有拒绝拖延提供海关资料情形？', options: ['无', '有但已纠正', '有未纠正'] },
            { q: '2年内是否被海关责令改正但未按要求改正？', options: ['无不按要求', '有已改正', '有未改正'] },
            { q: '2年内是否未履行检疫处理/退运/销毁等海关要求？', options: ['无不履行', '有已履行', '有未履行'] },
            { q: '2年内是否向海关作出书面承诺但未如实履行？', options: ['无不履行', '有已履行', '有未履行'] },
            { q: '企业及人员是否向海关人员行贿？', options: ['无', '有举报未查实', '有确认'] },
            { q: '相关人员任职的其他企业是否被认定为失信企业？', options: ['无', '有但已处理', '有未处理'] },
            { q: '分支机构是否被认定为失信企业？', options: ['无分支机构或未被认定', '有但已整改', '有被认定'] },
            { q: '出资人是否被认定为失信企业？', options: ['未被认定', '有但已整改', '有被认定'] },
            { q: '国家公共信用综合评价是否B以上？', options: ['B以上', 'B-', 'B以下'] },
            { q: '企业及人员在信用中国有无严重失信公示信息？', options: ['无', '有已修复', '有未修复'] },
            { q: '出资人在信用中国有无严重失信公示信息？', options: ['无', '有已修复', '有未修复'] },
            { q: '企业及出资人是否被公示为最低信用等级？', options: ['未被公示', '有但不最低', '被公示最低'] }
        ],
        security: [
            { q: '经营场所是否有设施防止未授权人员/货物进入？', options: ['设施完善', '基本完善', '不足'] },
            { q: '内外门窗/大门/围墙是否有锁闭或监控保护？', options: ['全面保护', '部分保护', '无保护'] },
            { q: '出入口是否配备人员值守或技术控制？', options: ['人员+技术', '单一控制', '无控制'] },
            { q: '受控区域（单证/数据/机房等）是否标识清晰并管控？', options: ['清晰标识+管控', '部分管控', '无管控'] },
            { q: '视频监控是否覆盖出入口/仓储区/围墙/停车场？', options: ['全面覆盖', '部分覆盖', '未覆盖'] },
            { q: '员工档案管理是否完善，动态清单是否更新？', options: ['完善并动态更新', '基本完善', '不完善'] },
            { q: '招聘时是否核实犯罪记录，敏感岗位是否定期背调？', options: ['严格背调', '部分背调', '无背调'] },
            { q: '员工是否携带身份标识，访客登记是否规范？', options: ['规范', '基本规范', '不规范'] },
            { q: '离职员工是否及时取消身份识别和系统授权？', options: ['及时取消', '有时延迟', '未取消'] },
            { q: '货物运输/装卸/存储安全管控措施是否到位？', options: ['到位', '基本到位', '不足'] },
            { q: '装货前是否使用七点检查法检查集装箱/车厢安全性？', options: ['严格执行', '有时执行', '未执行'] },
            { q: '封条是否有专人管理和登记，是否符合ISO标准？', options: ['规范管理', '基本规范', '不规范'] },
            { q: '货物是否存放在安全区域，是否有防未授权进入措施？', options: ['安全存放', '基本安全', '不安全'] },
            { q: '装运/接收前是否核实运输工具信息和驾驶员身份？', options: ['每次核实', '有时核实', '未核实'] },
            { q: '交接环节是否有签名/盖章等确认措施？', options: ['有', '部分有', '无'] },
            { q: '申报前是否核实木质包装IPPC标识？', options: ['严格核实', '有时核实', '不涉及'] },
            { q: '货物差异或法检不合格是否及时报告？', options: ['及时报告', '有时延迟', '未报告'] },
            { q: '出口货物是否实施监装并拍照/视频留存？', options: ['监装并留存', '监装未留存', '未监装'] },
            { q: '运输工具安全管控措施是否到位？', options: ['到位', '基本到位', '不足'] },
            { q: '是否检查运输工具可能藏匿非法物品的区域？', options: ['每次检查', '有时检查', '未检查'] },
            { q: '无人看管运输工具是否有安全防范措施？', options: ['有', '部分有', '无'] },
            { q: '驾驶员是否接受运输工具和货物安全培训？', options: ['定期培训', '不定期培训', '未培训'] },
            { q: '签订合同前是否审核商业伙伴资质和守法合规？', options: ['严格审核', '有时审核', '未审核'] },
            { q: '是否有完整动态的商业伙伴名单？', options: ['完整动态', '有但不完整', '无'] },
            { q: '是否对相关岗位开展贸易安全培训？', options: ['定期开展', '偶有开展', '未开展'] }
        ],
        bonus: [
            { q: '是否为国家级绿色工厂或绿色供应链管理企业？', options: ['是', '否', '申报中'] },
            { q: '是否为国家级专精特新"小巨人"企业？', options: ['是', '否', '申报中'] },
            { q: '是否被认定为国家企业技术中心？', options: ['是', '否', '申报中'] },
            { q: '是否为海关法定统计调查样本企业？', options: ['是', '否', '不清楚'] },
            { q: '委托的报关企业是否全部为AEO企业？', options: ['全部为AEO', '部分为AEO', '均非AEO'] },
            { q: '报关人员是否通过关务水平评估？', options: ['全部通过或中级≥30%', '初级通过', '不足5人/未参加'] }
        ]
    },
    certified: {
        internal: [
            { q: '是否指定海关业务联系人并保持沟通？', options: ['是', '基本是', '否'] },
            { q: '关务人员是否熟悉岗位业务和海关要求？', options: ['熟悉', '基本熟悉', '不熟悉'] },
            { q: '是否积极配合海关稽查调查核查？', options: ['积极配合', '基本配合', '配合不足'] },
            { q: '申报前是否进行内部复核？', options: ['双人复核', '单人复核', '无复核'] },
            { q: '单证归档保管是否规范？', options: ['规范', '基本规范', '不规范'] },
            { q: '是否有专门岗位进行禁限审查？', options: ['有', '兼职', '无'] },
            { q: '信息系统数据是否保存3年以上？', options: ['保存≥3年', '不足3年', '无系统'] },
            { q: '是否每年对进出口活动进行内部审计？', options: ['每年审计', '偶有开展', '未开展'] },
            { q: '问题是否由法定代表人组织处置和改进？', options: ['是', '部分', '否'] }
        ],
        finance: [
            { q: '审计报告是否无保留意见？', options: ['无保留', '保留', '否定/无法表示'] },
            { q: '偿债指标（资产负债率等）是否达标？', options: ['2项以上达标', '1项达标', '都不达标'] },
            { q: '是否存在解散或破产情形？', options: ['不存在', '存在风险', '已破产'] }
        ],
        compliance: [
            { q: '海关注册信息是否相符？', options: ['相符', '有差异', '不符'] },
            { q: '相关人员是否因故意犯罪被刑事处罚？', options: ['无', '有已处理', '有未处理'] },
            { q: '行政处罚次数和金额是否在规定范围？', options: ['达标', '接近超标', '超标'] },
            { q: '2年内是否有进出口活动？', options: ['有', '较少', '无'] },
            { q: '是否超期未缴纳税款/罚款？', options: ['无', '有已补缴', '有未缴'] },
            { q: '报关单查获率是否达标？', options: ['达标', '接近超标', '超标'] },
            { q: '追征税款是否在规定范围？', options: ['达标', '接近超标', '超标'] },
            { q: '是否委托/接受失信企业办理业务？', options: ['无', '有已整改', '有未整改'] },
            { q: '是否有海关管理违规情形？', options: ['无', '有轻微', '有严重'] },
            { q: '相关人员任职的其他企业是否失信？', options: ['无', '有已处理', '有未处理'] },
            { q: '分支机构/出资人是否被认定为失信？', options: ['未被认定', '有已整改', '有被认定'] },
            { q: '公共信用评价是否B以上？', options: ['B以上', 'B-', 'B以下'] },
            { q: '信用中国有无严重失信公示？', options: ['无', '有已修复', '有未修复'] }
        ],
        security: [
            { q: '场所是否有防止未授权进入的设施？', options: ['有', '部分有', '无'] },
            { q: '出入口是否有人员值守或技术控制？', options: ['有', '部分有', '无'] },
            { q: '员工档案管理是否完善？', options: ['完善', '基本完善', '不完善'] },
            { q: '访客是否有身份识别和进出登记？', options: ['规范', '基本规范', '不规范'] },
            { q: '货物安全管控措施是否到位？', options: ['到位', '基本到位', '不足'] },
            { q: '封条管理是否规范？', options: ['规范', '基本规范', '不规范'] },
            { q: '交接环节是否有确认措施？', options: ['有', '部分有', '无'] },
            { q: '木质包装是否核实IPPC标识？', options: ['严格核实', '有时核实', '不涉及'] },
            { q: '出口货物是否实施监装？', options: ['监装并留存', '监装未留存', '未监装'] },
            { q: '运输工具安全管控是否到位？', options: ['到位', '基本到位', '不足'] },
            { q: '无人看管运输工具是否有安全防范？', options: ['有', '部分有', '无'] },
            { q: '签订合同前是否审核商业伙伴资质？', options: ['严格审核', '有时审核', '未审核'] },
            { q: '商业伙伴名单是否完整动态？', options: ['完整动态', '有但不完整', '无'] },
            { q: '是否开展贸易安全培训？', options: ['定期开展', '偶有开展', '未开展'] },
            { q: '加分项（绿色/专精/技术中心/统计/报关/关务水平）是否有符合项？', options: ['有符合项', '申报中', '无'] }
        ],
        bonus: [
            { q: '是否为国家级绿色工厂？', options: ['是', '否', '申报中'] },
            { q: '是否为专精特新小巨人？', options: ['是', '否', '申报中'] },
            { q: '是否为国家级企业技术中心？', options: ['是', '否', '申报中'] },
            { q: '是否为海关统计样本企业？', options: ['是', '否', '不清楚'] },
            { q: '委托报关企业是否全部为AEO？', options: ['全部', '部分', '均非'] },
            { q: '报关人员是否通过关务水平评估？', options: ['全部或中级≥20%', '初级', '不足5人/未参加'] }
        ]
    }
};
...
let authToken = loadData('authToken', '');
...
function getAuthHeaders(skipContentType) {
    ...
    if (authToken) {
        ...
        headers['Authorization'] = 'Basic ' + btoa('aeo:aeo2026');
    }
    return headers;
}
...
async function initFromServer() {
    const syncKeys = ['companyInfo','tasks','assessmentAnswers','assessmentResults',
...
// 增强型 saveData：写入 localStorage + 异步同步到服务器
function saveData(key, val) {
    try { localStorage.setItem('aeo_' + key, JSON.stringify(val)); } catch(e) {}
    // 异步同步到服务器（fire-and-forget，不阻塞 UI）
    fetch(API_BASE + '/api/data/' + key, {
        method: 'PUT',
        headers: getAuthHeaders(),
        body: JSON.stringify(val)
    }).catch(function() { /* 服务器不可用时静默失败，本地数据不受影响 */ });
}
...
function doLogin() {
    try {
        ...
        fetch(API_BASE + '/api/auth/login', {
            ...
            if (confirm('服务器连接失败，是否进入离线演示模式？')) {
                currentUser = { name: '离线用户', role: 'customs_officer' };
                document.getElementById('loginOverlay').style.display = 'none';
                document.getElementById('appContainer').style.display = 'block';
                document.getElementById('headerUserName').textContent = '离线用户';
                document.getElementById('headerRoleBadge').textContent = '关务经理';
                initApp();
            }
        });
    } catch(e) {
...
function navigateTo(module) {
    ...
    if (module === 'tasks') { loadTasks(); renderTaskTable(); renderTaskKanban(); }
...
function updateDashboard() {
    const assessmentResults = loadData('assessmentResults', {});
    ...
    if (history.length > 0) {
        ...
        // Fallback: individual answer values are 0-3, normalize to 0-100
        let sum = 0, count = 0;
        Object.keys(assessmentResults).forEach(function(k) {
            sum += parseInt(assessmentResults[k]) || 0;
            count++;
        });
        avgAssessment = count > 0 ? Math.round(sum / (count * 3) * 100) : 0;
    }
    ...
    // --- Assessment dimension score breakdown ---
    ...
    var qs = questionBank && questionBank[assessmentType];
    if (qs) {
        var dimScores = {};
        Object.keys(qs).forEach(function(dimKey) {
            var questions = qs[dimKey];
            var sum = 0, answered = 0;
            questions.forEach(function(q, qi) {
                var val = assessmentResults[dimKey + '_' + qi];
                if (val !== undefined && val !== '') { answered++; sum += parseInt(val) || 0; }
            });
            dimScores[dimKey] = { score: questions.length > 0 ? Math.round(sum / (questions.length * 3) * 100) : 0, answered: answered };
        });
        saveData('dimensionScores', dimScores);
        var assessedDims = Object.keys(dimScores).filter(function(k) { return dimScores[k].answered > 0; });
        if (assessedDims.length > 0) {
            var dimNameMap = { internal:'内部控制', finance:'财务状况', compliance:'守法规范', security:'贸易安全', bonus:'附加标准', it:'信息系统', audit:'内审改进' };
            dimBreakdown.innerHTML = assessedDims.map(function(dimKey) {
                var pct = dimScores[dimKey].score;
            ...
            dimBreakdown.style.display = 'none';
        }
    } else {
...
function loadStandards() {
    ...
    dimOrder.forEach(function(key) {
        const dim = data[key]; if (!dim) return;
        const count = dim.items.length;
        const done = dim.items.filter(function(it) { return it.evidence.policy && it.evidence.record && it.evidence.approval; }).length;
        ...
        html += '<div class="flex items-center justify-between mb-1"><div class="flex items-center space-x-1.5"><i class="fas fa-' + dim.icon + ' text-' + dim.color + '-600 text-xs"></i><span class="text-xs font-semibold text-slate-700">' + dim.title + '</span></div><span class="text-xs font-medium text-' + dim.color + '-600">' + pct + '%</span></div>';
        html += '<div class="flex items-center justify-between"><span class="text-base font-bold text-slate-800">' + done + '</span><span class="text-xs text-slate-400">共' + count + '项</span></div>';
        html += '<div class="mt-1.5 h-1 bg-slate-100 rounded-full overflow-hidden"><div class="h-full bg-' + dim.color + '-500 rounded-full" style="width:' + pct + '%"></div></div></div>';
    });
    html += '</div>';

    // Collect individual standards
    var individualItems = [];
    if (typeof INDIVIDUAL_STANDARDS !== 'undefined') {
        Object.keys(INDIVIDUAL_STANDARDS).forEach(function(bizKey) {
            var biz = INDIVIDUAL_STANDARDS[bizKey];
            biz.items.forEach(function(it) {
                individualItems.push({ bizKey: bizKey, bizTitle: biz.title, bizIcon: biz.icon, bizColor: biz.color, item: it });
            });
        });
    }
    // Add individual standards stat card
    if (individualItems.length > 0) {
        var allIndivDone = individualItems.filter(function(ii) { return ii.item.evidence && ii.item.evidence.policy && ii.item.evidence.record && ii.item.evidence.approval; }).length;
        var indivPct = Math.round(allIndivDone / individualItems.length * 100);
        ...
        html += '<div class="flex items-center justify-between mb-1"><div class="flex items-center space-x-1.5"><i class="fas fa-industry text-amber-600 text-xs"></i><span class="text-xs font-semibold text-slate-700">单项标准</span></div><span class="text-xs font-medium text-amber-600">' + indivPct + '%</span></div>';
        html += '<div class="flex items-center justify-between"><span class="text-base font-bold text-slate-800">' + allIndivDone + '</span><span class="text-xs text-slate-400">共' + individualItems.length + '项</span></div>';
        html += '<div class="mt-1.5 h-1 bg-slate-100 rounded-full overflow-hidden"><div class="h-full bg-amber-500 rounded-full" style="width:' + indivPct + '%"></div></div></div>';
        html += '</div>';
    }
    ...
    html += '<input type="text" class="standard-search w-full border border-slate-300 rounded-lg py-2.5 pr-3 text-sm focus:outline-none focus:border-slate-500 bg-white" placeholder="搜索标准名称、编号或部门..." oninput="filterStandardItems(this.value)">';
    html += '</div>';

    // 3. Mobile TOC pills (horizontal scroll, visible only on < lg)
    html += '<div class="lg:hidden overflow-x-auto toc-mobile-pills mb-4 -mx-1 px-1">';
    html += '<div class="flex space-x-1.5">';
    dimOrder.forEach(function(key) {
        const dim = data[key]; if (!dim) return;
        html += '<button class="flex-shrink-0 px-3 py-1.5 text-xs font-medium rounded-full border border-slate-300 text-slate-600 hover:bg-slate-100 whitespace-nowrap" onclick="toggleAccordion(\'' + key + '\')"><i class="fas fa-' + dim.icon + ' mr-1 text-' + dim.color + '-500"></i>' + dim.title + '</button>';
    });
    // Individual standards mobile pill
    if (individualItems.length > 0) {
    ...
    dimOrder.forEach(function(key) {
        ...
        html += '<a href="javascript:void(0)" class="toc-dim-link flex items-center justify-between px-3 py-2 rounded-lg text-sm text-slate-700 hover:bg-slate-100 transition-colors" onclick="toggleAccordion(\'' + key + '\')"><span class="flex items-center space-x-2"><i class="fas fa-' + dim.icon + ' text-' + dim.color + '-500 text-xs"></i><span>' + dim.title + '</span></span><span class="flex items-center space-x-1"><span class="text-xs text-slate-400">' + count + '</span><i class="fas fa-chevron-right text-slate-300"></i></span></a>';
        if (dim.subcategories && dim.subcategories.length) {
            dim.subcategories.forEach(function(sc) {
                var scId = 'subcat-' + key + '-' + sc.name.replace(/\s+/g, '');
                html += '<a href="javascript:void(0)" class="toc-sub-link flex items-center pl-7 pr-2 py-1 text-xs text-slate-500 hover:text-slate-700 hover:bg-slate-50 rounded-lg transition-colors" onclick="document.getElementById(\'' + scId + '\').scrollIntoView({behavior:\'smooth\',block:\'start\'})"><span class="truncate">' + safeEs(sc.name) + '</span></a>';
            });
        }
        html += '</div>';
    });
    ...
    if (individualItems.length > 0) {
        var bizKeys = Object.keys(INDIVIDUAL_STANDARDS);
        html += '<div class="toc-group" data-dim="individual">';
        html += '<a href="javascript:void(0)" class="toc-dim-link flex items-center justify-between px-3 py-2 rounded-lg text-sm text-slate-700 hover:bg-slate-100 transition-colors" onclick="toggleAccordion(\'individual\')"><span class="flex items-center space-x-2"><i class="fas fa-industry text-amber-500 text-xs"></i><span>单项标准</span></span><span class="flex items-center space-x-1"><span class="text-xs text-slate-400">' + individualItems.length + '</span><i class="fas fa-chevron-right text-slate-300"></i></span></a>';
        bizKeys.forEach(function(bizKey) {
            var biz = INDIVIDUAL_STANDARDS[bizKey];
            var scId = 'subcat-individual-' + bizKey;
            html += '<a href="javascript:void(0)" class="toc-sub-link flex items-center pl-7 pr-2 py-1 text-xs text-slate-500 hover:text-slate-700 hover:bg-slate-50 rounded-lg transition-colors" onclick="document.getElementById(\'' + scId + '\').scrollIntoView({behavior:\'smooth\',block:\'start\'})"><span class="truncate">' + safeEs(biz.title) + '</span></a>';
        });
        html += '</div>';
    }
    html += '</div></div></div>';
    ...
    dimOrder.forEach(function(key, idx) {
        ...
        html += '<div class="flex items-center space-x-3"><i class="fas fa-' + dim.icon + ' text-' + dim.color + '-600"></i><h3 class="font-bold text-slate-800">' + dim.title + '</h3><span class="text-xs bg-slate-100 px-2.5 py-0.5 rounded-full text-slate-500 font-medium">' + count + '项</span></div>';
        html += '<div class="flex items-center space-x-3"><span class="text-sm text-slate-500 hidden sm:inline">资料完成 </span><span class="text-sm font-bold text-slate-700">' + done + '/' + count + '</span><div class="w-20 h-1.5 bg-slate-100 rounded-full overflow-hidden hidden sm:block"><div class="h-full bg-' + dim.color + '-500 rounded-full" style="width:' + pct + '%"></div></div><i class="fas fa-chevron-down text-slate-300 text-xs"></i></div>';
        html += '</div>';
        ...
        if (dim.subcategories && dim.subcategories.length) {
            dim.subcategories.forEach(function(sc) {
                var scId = 'subcat-' + key + '-' + sc.name.replace(/\s+/g, '');
                html += '<div id="' + scId + '" class="px-4 py-2 bg-slate-50 border-b border-slate-100"><span class="text-xs font-semibold text-slate-500"><i class="fas fa-folder-open mr-1"></i>' + safeEs(sc.name) + '</span></div>';
                sc.items.forEach(function(it) {
                    html += '<div class="standard-item">' + renderStandardItem(it) + '</div>';
                });
            });
        } else {
    ...
    if (individualItems.length > 0) {
        var ibKeys = Object.keys(INDIVIDUAL_STANDARDS);
        ...
        html += '<div class="flex items-center space-x-3"><i class="fas fa-industry text-amber-600"></i><h3 class="font-bold text-slate-800">单项标准</h3><span class="text-xs bg-slate-100 px-2.5 py-0.5 rounded-full text-slate-500 font-medium">' + individualItems.length + '项</span></div>';
        html += '<div class="flex items-center space-x-3"><span class="text-sm text-slate-500 hidden sm:inline">资料完成 </span><span class="text-sm font-bold text-slate-700">' + allIndivDone + '/' + individualItems.length + '</span><div class="w-20 h-1.5 bg-slate-100 rounded-full overflow-hidden hidden sm:block"><div class="h-full bg-amber-500 rounded-full" style="width:' + indivPct + '%"></div></div><i class="fas fa-chevron-down text-slate-300 text-xs"></i></div>';
        html += '</div>';
        html += '<div class="dim-accordion-detail divide-y divide-slate-100 hidden">';
        ibKeys.forEach(function(bizKey) {
            var biz = INDIVIDUAL_STANDARDS[bizKey];
            var scId = 'subcat-individual-' + bizKey;
            html += '<div id="' + scId + '" class="px-4 py-2 bg-slate-50 border-b border-slate-100"><span class="text-xs font-semibold text-slate-500"><i class="fas fa-folder-open mr-1"></i>' + safeEs(biz.title) + '</span></div>';
            biz.items.forEach(function(it) {
                html += '<div class="standard-item">' + renderStandardItem(it) + '</div>';
            });
        });
...
function renderStandardItem(it) {
    const ev = it.evidence;
    const dots = [{label:'制度',done:ev.policy},{label:'记录',done:ev.record},{label:'审批',done:ev.approval}];
    var officialBadge = it.officialId ? '<span class="text-xs text-slate-400 font-mono ml-1">' + it.officialId + '</span>' : '';
    return '<div class="p-4 border-b border-slate-100 last:border-b-0"><div class="flex items-start justify-between"><div class="flex-1"><div class="flex items-center space-x-2 mb-1"><span class="text-xs font-mono font-bold text-slate-400">' + it.id + '</span><span class="font-medium text-slate-800">' + it.name + '</span>' + officialBadge + '</div><p class="text-xs text-slate-500 mb-2">' + it.desc + '</p><div class="flex items-center space-x-3 text-xs text-slate-400"><span><i class="fas fa-building mr-1"></i>' + it.dept + '</span>' + (it.supportDept ? '<span><i class="fas fa-users mr-1"></i>' + it.supportDept + '</span>' : '') + '<span><i class="far fa-clock mr-1"></i>' + it.frequency + '</span></div></div><div class="flex items-center space-x-1.5 ml-3">' + dots.map(d => '<span class="evidence-dot ' + (d.done ? 'done' : 'miss') + '">' + d.label + '</span>').join('') + '</div></div>' +
        '<div class="mt-3 pl-4 border-l-2 border-slate-200 ml-1">' +
        // Config info and button (before standard requirements)
        (function() {
            var cfg = getStdConfig(it.id);
            var html = '';
            if (cfg && (cfg.owner || cfg.assistant || cfg.startDate || cfg.dueDate || cfg.dept)) {
                var parts = [];
                if (cfg.dept && cfg.dept !== it.dept) parts.push('<span><i class="fas fa-building mr-1"></i>' + cfg.dept + '</span>');
                if (cfg.owner) parts.push('<span><i class="fas fa-user mr-1"></i>' + cfg.owner + '</span>');
                if (cfg.assistant) parts.push('<span><i class="fas fa-users mr-1"></i>协:' + cfg.assistant + '</span>');
                if (cfg.startDate) parts.push('<span><i class="far fa-calendar-alt mr-1"></i>' + cfg.startDate + '</span>');
                if (cfg.dueDate) parts.push('<span><i class="far fa-clock mr-1"></i>截:' + cfg.dueDate + '</span>');
                html += '<div class="mb-2 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-slate-500 bg-blue-50 rounded px-2 py-1">' + parts.join('') + '</div>';
            }
            html += '<div class="mb-2"><button onclick="showStandardConfigModal(\'' + it.id + '\',\'' + it.name.replace(/'/g, "\\'") + '\')" class="text-xs text-slate-500 hover:text-slate-700 hover:underline" title="配置责任人/日期"><i class="fas fa-cog mr-1"></i>配置责任人/日期</button></div>';
            return html;
        })() +
        '<div class="p-3 bg-slate-50 rounded-lg text-xs space-y-2">' +
        '<p><span class="font-semibold text-slate-700">📋 标准要求：</span><span class="text-slate-600">' + (it.standard || it.desc) + '</span></p>' +
        (it.checkFile ? '<p><span class="font-semibold text-slate-700">📄 检查文件：</span><span class="text-slate-600">' + it.checkFile + '</span></p>' : '') +
        (it.checkInterview ? '<p><span class="font-semibold text-slate-700">💬 询问：</span><span class="text-slate-600">' + it.checkInterview + '</span></p>' : '') +
        (it.checkSite ? '<p><span class="font-semibold text-slate-700">🔍 实地查看：</span><span class="text-slate-600">' + it.checkSite + '</span></p>' : '') +
        (it.checkRandom ? '<p><span class="font-semibold text-slate-700">📋 随机抽查：</span><span class="text-slate-600">' + it.checkRandom + '</span></p>' : '') +
        (it.sampleDocs && it.sampleDocs.length ? '<p><span class="font-semibold text-slate-700">📎 样本资料：</span><span class="text-slate-600">' + it.sampleDocs.join('、') + '</span></p>' : '') +
        (it.checkPoints && it.checkPoints.length ? '<div><span class="font-semibold text-slate-700">⚠️ 检查要点：</span><ul class="list-disc list-inside text-slate-600 mt-1">' + it.checkPoints.map(cp => '<li>' + cp + '</li>').join('') + '</ul></div>' : '') +
        '</div>' +
        '<div class="mt-2 flex items-center justify-between"><p class="text-xs text-slate-400">📎 资料要求:' + it.evidenceDesc + '</p>' +
        '<div class="flex items-center space-x-2">' +
        '<button onclick="showStandardConfigModal(\'' + it.id + '\',\'' + it.name.replace(/'/g, "\\'") + '\')" class="text-xs text-slate-500 hover:text-slate-700 hover:underline" title="配置责任人/日期"><i class="fas fa-cog mr-1"></i>配置</button>' +
        '<button onclick="showEvidenceUploadModal(\'' + it.id + '\')" class="text-xs text-blue-600 hover:text-blue-800 hover:underline"><i class="fas fa-upload mr-1"></i>上传资料</button></div></div>' +
        '<div id="evidence-list-' + it.id.replace(/[^a-zA-Z0-9]/g, '') + '" class="mt-2 flex flex-wrap gap-1.5"></div>' +
        // Show config info if available
        (function() {
            var cfg = getStdConfig(it.id);
            if (!cfg || (!cfg.owner && !cfg.assistant && !cfg.startDate && !cfg.dueDate && !cfg.dept)) return '';
            var parts = [];
            if (cfg.dept && cfg.dept !== it.dept) parts.push('<span><i class="fas fa-building mr-1"></i>' + cfg.dept + '</span>');
            if (cfg.owner) parts.push('<span><i class="fas fa-user mr-1"></i>' + cfg.owner + '</span>');
            if (cfg.assistant) parts.push('<span><i class="fas fa-users mr-1"></i>协:' + cfg.assistant + '</span>');
            if (cfg.startDate) parts.push('<span><i class="far fa-calendar-alt mr-1"></i>' + cfg.startDate + '</span>');
            if (cfg.dueDate) parts.push('<span><i class="far fa-clock mr-1"></i>截:' + cfg.dueDate + '</span>');
            return '<div class="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-slate-500 bg-blue-50 rounded px-2 py-1">' + parts.join('') + '</div>';
        })() +
        '</div></div>';
}
// ── 标准任务配置（责任人/协助人/日期） ──
function loadStdTaskConfig() { return loadData('stdTaskConfig', {}); }
function saveStdTaskConfig(data) { saveData('stdTaskConfig', data); }

function getStdConfig(stdId) {
    var all = loadStdTaskConfig();
    return all[stdId] || null;
}

function showStandardConfigModal(stdId, stdName) {
    var config = getStdConfig(stdId);
    document.getElementById('stdConfigItemKey').value = stdId;
    document.getElementById('stdConfigTitle').textContent = stdId + ' ' + stdName;
    // Populate dept dropdown
    var deptSel = document.getElementById('stdConfigDept');
    ...
    // Apply saved values
    if (config) {
        deptSel.value = config.dept || '';
        document.getElementById('stdConfigOwner').value = config.owner || '';
        document.getElementById('stdConfigAssistant').value = config.assistant || '';
        document.getElementById('stdConfigStartDate').value = config.startDate || '';
        document.getElementById('stdConfigDueDate').value = config.dueDate || '';
    } else {
        deptSel.value = '';
        document.getElementById('stdConfigOwner').value = '';
        document.getElementById('stdConfigAssistant').value = '';
        document.getElementById('stdConfigStartDate').value = '';
        document.getElementById('stdConfigDueDate').value = '';
    }
    document.getElementById('standardConfigModal').classList.add('active');
}

function saveStandardConfig() {
    var stdId = document.getElementById('stdConfigItemKey').value;
    if (!stdId) return;
    var config = {
        dept: document.getElementById('stdConfigDept').value,
        owner: document.getElementById('stdConfigOwner').value.trim(),
        assistant: document.getElementById('stdConfigAssistant').value.trim(),
        startDate: document.getElementById('stdConfigStartDate').value,
        dueDate: document.getElementById('stdConfigDueDate').value
    };
    var all = loadStdTaskConfig();
    all[stdId] = config;
    saveStdTaskConfig(all);
    closeModal('standardConfigModal');
    // Re-render the standard view
    loadStandards();
    showToast('标准配置已保存', 'success');
}

function stdConfigGenerateTask() {
    var stdId = document.getElementById('stdConfigItemKey').value;
    if (!stdId) return;
    // Save config first
    var config = {
    ...
    var stdName = stdId;
    try {
        var data = standardsData[stdType];
        if (data) {
            Object.keys(data).forEach(function(dk) {
                data[dk].items.forEach(function(it) {
                    if (it.id === stdId) stdName = it.name;
                });
            });
        }
    } catch(e) {}
    ...
    closeModal('standardConfigModal');
    loadStandards();
    showToast('配置已保存，任务已创建: ' + stdName, 'success');
    addAuditLog('从标准创建任务: ' + stdId, 'task', config.dept + ' · ' + config.owner);
}

function renderDeptView() {
    const data = standardsData[stdType]; if (!data) return '';
    const deptMap = {}; DEPARTMENTS.forEach(d => deptMap[d] = []);
    Object.keys(data).forEach(dimKey => { data[dimKey].items.forEach(it => { if (deptMap[it.dept]) deptMap[it.dept].push(it); }); });
    return DEPARTMENTS.filter(d => deptMap[d].length > 0).map(dept => {
        const items = deptMap[dept];
        const done = items.filter(it => it.evidence.policy && it.evidence.record && it.evidence.approval).length;
        const pct = items.length > 0 ? Math.round(done/items.length*100) : 0;
        const sc = pct >= 80 ? 'emerald' : pct >= 50 ? 'amber' : 'red';
        return '<div class="card-business rounded-lg p-4"><div class="flex items-center justify-between mb-3"><h3 class="font-bold text-slate-800"><i class="fas fa-building text-slate-400 mr-2"></i>' + dept + '</h3><span class="text-sm font-bold text-' + sc + '-600">' + done + '/' + items.length + ' ' + (pct >= 80 ? '✅' : pct >= 50 ? '⚠️' : '❌') + '</span></div><div class="progress-bar mb-3"><div class="progress-fill bg-' + sc + '-500" style="width:' + pct + '%"></div></div><div class="space-y-2">' + items.map(it => '<div class="flex items-center justify-between p-2 bg-slate-50 rounded"><div class="flex items-center space-x-2"><span class="text-xs font-mono text-slate-400">' + it.id + '</span><span class="text-sm text-slate-700">' + it.name + '</span></div><div class="flex items-center space-x-1">' + ['policy','record','approval'].map((k, i) => '<span class="evidence-dot ' + (it.evidence[k] ? 'done' : 'miss') + '">' + ['制度','记录','审批'][i] + '</span>').join('') + '</div></div>').join('') + '</div></div>';
    }).join('');
}
...
// ── 标准资料文件上传 ──────────────────────────────────
let _evidenceUploadStdId = '';

function showEvidenceUploadModal(stdId) {
    _evidenceUploadStdId = stdId;
    var id = stdId.replace(/[^a-zA-Z0-9]/g, '');
    document.getElementById('evidenceUploadStdId').textContent = stdId;
    // Find the standard item name
    var name = stdId;
    var data = standardsData[stdType] || standardsData['advanced'];
    if (data) {
        Object.keys(data).forEach(function(dimKey) {
            var dim = data[dimKey];
            var found = (dim.items || []).find(function(it) { return it.id === stdId; });
            if (found) name = found.name;
        });
    }
    document.getElementById('evidenceUploadStdName').textContent = name;
    document.getElementById('evidenceUploadStdKey').value = stdId;
...
function showTaskModal() {
    ...
    const data = standardsData['advanced'];
    if (data) Object.keys(data).forEach(dimKey => { data[dimKey].items.forEach(it => { stdSelect.innerHTML += '<option value="' + it.id + '">' + it.id + ' ' + it.name + '</option>'; }); });
...
function createNewTask() {
    ...
    saveData('tasks', tasks);
    closeTaskModal();
    ['taskNameInput','taskOwnerInput','taskDueInput','taskReqInput','taskAttachInput'].forEach(id => document.getElementById(id).value = '');
    showToast('任务创建成功: ' + name);
    addAuditLog('创建任务: ' + name, 'task', dept + ' · ' + owner);
    renderTaskTable(); renderTaskKanban(); updateDashboard();
}
...
function loadAssessment() {
    ...
    const qs = questionBank[assessmentType]; if (!qs) return;
    assessmentAnswers = loadData('assessmentAnswers', {});
    populateAssessmentYears();
    const container = document.getElementById('questionnaireContainer');
    container.innerHTML = Object.keys(qs).map(dimKey => {
        const dim = standardsData[assessmentType][dimKey];
        const questions = qs[dimKey];
        return '<div class="card-business rounded-lg p-6 mb-6"><h3 class="font-bold text-slate-800 mb-4"><i class="fas fa-' + dim.icon + ' text-' + dim.color + '-600 mr-2"></i>' + dim.title + '</h3><div class="space-y-4">' + questions.map((q, qi) => {
            const key = dimKey + '_' + qi;
            const saved = assessmentAnswers[key] || '';
            return '<div class="assessment-question"><p class="font-medium text-slate-700 text-sm mb-3">' + (qi+1) + '. ' + q.q + '</p><div class="flex flex-wrap gap-3">' + q.options.map((opt, oi) => {
                const val = String(3 - oi);
                const checked = saved === val ? 'checked' : '';
                return '<label class="flex items-center space-x-2 px-4 py-2 bg-white border border-slate-200 rounded-lg cursor-pointer hover:bg-blue-50 hover:border-blue-300 transition-colors"><input type="radio" name="q_' + dimKey + '_' + qi + '" value="' + val + '" ' + checked + ' onchange="saveAssessmentAnswer(\'' + key + '\',\'' + val + '\')" class="mr-1"><span class="text-sm text-slate-700">' + opt + '</span></label>';
            }).join('') + '</div></div>';
        }).join('') + '</div></div>';
    }).join('');
    updateAssessmentProgress();
}
function saveAssessmentAnswer(key, val) { assessmentAnswers[key] = val; saveData('assessmentAnswers', assessmentAnswers); updateAssessmentProgress(); }
function updateAssessmentProgress() {
    const qs = questionBank[assessmentType]; if (!qs) return;
    let totalScore = 0, totalQs = 0;
    Object.keys(qs).forEach(dimKey => {
        const questions = qs[dimKey];
        let answered = 0, score = 0;
        questions.forEach((q, qi) => {
            const val = assessmentAnswers[dimKey + '_' + qi];
            if (val !== undefined && val !== '') { answered++; score += parseInt(val) || 0; }
        });
        totalQs += questions.length; totalScore += score;
        const cap = dimKey.charAt(0).toUpperCase() + dimKey.slice(1);
        document.getElementById('progress' + cap).textContent = answered + '/' + questions.length;
        document.getElementById('progressBar' + cap).style.width = (questions.length > 0 ? Math.round(answered/questions.length*100) : 0) + '%';
    });
    document.getElementById('estimatedScore').textContent = totalQs > 0 ? Math.round(totalScore / (totalQs*3) * 100) : 0;
}
function switchAssessmentType() { assessmentType = document.getElementById('assessmentType').value; assessmentAnswers = {}; loadAssessment(); }
function submitAssessment() {
    const qs = questionBank[assessmentType]; if (!qs) return;
    const year = document.getElementById('assessmentYear').value;
    const officer = document.getElementById('assessmentOfficer').value.trim();
    const reviewer = document.getElementById('assessmentReviewer').value.trim();
    if (!year) { showToast('请选择评估年度', 'error'); return; }
    if (!officer) { showToast('请填写关务人员', 'error'); return; }
    let total = 0, answered = 0;
    Object.keys(qs).forEach(dimKey => { qs[dimKey].forEach((q, qi) => { const val = assessmentAnswers[dimKey + '_' + qi]; if (val !== undefined && val !== '') { answered++; total += parseInt(val) || 0; } }); });
    const totalQs = Object.values(qs).reduce((s, a) => s + a.length, 0);
    const score = totalQs > 0 ? Math.round(total / (totalQs*3) * 100) : 0;
    // Save current answers to latest
    saveData('assessmentResults', assessmentAnswers);
    saveData('lastAssessmentScore', score);
    saveData('lastAssessmentDate', new Date().toISOString());
    // Save to history
    const history = loadData('assessmentHistory', []);
    const id = 'ASMT-' + year + '-' + String(history.filter(h => h.year === year).length + 1).padStart(3, '0');
    history.unshift({
        id: id,
        year: year,
        type: assessmentType,
        ...
        reviewer: reviewer || '',
        score: score,
        answers: JSON.parse(JSON.stringify(assessmentAnswers)),
    ...
    showToast('评估已提交！编号: ' + id + ' 综合得分: ' + score + '/100', 'success');
    updateDashboard();
    renderAssessmentHistory();
}
function resetAssessment() { if (!confirm('确定要重置所有评估答案吗？')) return; assessmentAnswers = {}; saveData('assessmentAnswers', {}); loadAssessment(); showToast('评估问卷已重置', 'warning'); }

// ── 评估问卷打印导出 ──
function printAssessment() {
    const qs = questionBank[assessmentType]; if (!qs) { showToast('请先加载评估问卷', 'warning'); return; }
    var answers = assessmentAnswers || loadData('assessmentAnswers', {});
    ...
    var totalScore = 0, totalQs = 0;
    Object.keys(qs).forEach(function(dk) { var questions = qs[dk]; questions.forEach(function(q, qi) { var val = answers[dk + '_' + qi]; if (val !== undefined && val !== '') { totalScore += parseInt(val) || 0; totalQs++; } }); });
    var allQs = Object.values(qs).reduce(function(s, a) { return s + a.length; }, 0);
    var pct = allQs > 0 ? Math.round(totalScore / (allQs * 3) * 100) : 0;
    var optLabels = { '3': '完全符合', '2': '基本符合', '1': '部分符合', '0': '不符合' };
    ...
    Object.keys(qs).forEach(function(dk) {
        var dim = standardsData[assessmentType][dk];
        var questions = qs[dk];
        var dimAnswered = 0, dimScore = 0;
        questions.forEach(function(q, qi) { var val = answers[dk + '_' + qi]; if (val !== undefined && val !== '') { dimAnswered++; dimScore += parseInt(val) || 0; } });
        html += '<div class="pa-dim"><h2>' + (dim.title || dk) + ' &mdash; ' + dimAnswered + '/' + questions.length + ' 题已答</h2>';
        questions.forEach(function(q, qi) {
            var key = dk + '_' + qi;
            var val = answers[key];
            var optText = val !== undefined && val !== '' ? optLabels[val] || ('得分: ' + val) : '未作答';
            html += '<div class="pa-q"><div class="q-text">' + (qi+1) + '. ' + q.q + '</div><div class="q-answer">' + optText + '</div></div>';
        });
        html += '</div>';
    });
    html += '<div class="pa-score"><div class="big">' + pct + '分</div><p>综合合规得分（满分100分）</p><p style="font-size:0.75rem;color:#999;margin-top:0.5rem;">得分说明: 完全符合=3分, 基本符合=2分, 部分符合=1分, 不符合=0分</p></div>';
    html += '</div>';
...
function viewPastAssessment(id) {
    ...
    const qs = questionBank[rec.type];
    let bodyHtml = '<div class="mb-4 p-4 bg-slate-50 rounded-lg grid grid-cols-2 md:grid-cols-5 gap-3 text-sm"><div><span class="text-slate-500">编号</span><p class="font-medium">' + rec.id + '</p></div><div><span class="text-slate-500">年度</span><p class="font-medium">' + rec.year + '年</p></div><div><span class="text-slate-500">类型</span><p class="font-medium">' + typeLabel + '</p></div><div><span class="text-slate-500">关务人员</span><p class="font-medium">' + escapeHtml(rec.officer) + '</p></div><div><span class="text-slate-500">复审人员</span><p class="font-medium">' + escapeHtml(rec.reviewer || '-') + '</p></div></div>' +
        '<div class="mb-4 text-center"><span class="text-4xl font-bold ' + (rec.score >= 80 ? 'text-emerald-600' : rec.score >= 60 ? 'text-amber-600' : 'text-red-600') + '">' + rec.score + '</span><span class="text-slate-400 text-sm"> / 100</span></div>';
    Object.keys(qs).forEach(dimKey => {
        const questions = qs[dimKey];
        bodyHtml += '<div class="mb-4"><h4 class="font-bold text-sm text-slate-700 mb-2"><i class="fas ' + dimIcons[dimKey] + ' text-' + dimColors[dimKey] + '-600 mr-1"></i>' + dimLabels[dimKey] + '</h4>';
        questions.forEach((q, qi) => {
            const val = rec.answers[dimKey + '_' + qi];
            const optIdx = val ? (3 - parseInt(val)) : -1;
            const optText = optIdx >= 0 ? q.options[optIdx] : '<span class="text-slate-400">未作答</span>';
            const scoreLabel = val ? (['0分','5分','10分'][3 - parseInt(val)] || '') : '';
            bodyHtml += '<div class="flex justify-between items-center py-1.5 border-b border-slate-100 last:border-0"><span class="text-sm text-slate-600">' + (qi+1) + '. ' + q.q + '</span><span class="text-xs whitespace-nowrap ' + (optIdx >= 0 ? 'text-slate-700 bg-slate-100 px-2 py-0.5 rounded' : 'text-red-400') + '">' + optText + (scoreLabel ? ' (' + scoreLabel + ')' : '') + '</span></div>';
        });
        bodyHtml += '</div>';
    });
...
function generateAeoReport() {
  ...
  var assessmentResults = loadData('assessmentResults', {});
...
function exportData(format) {
    const data = { exportTime: new Date().toISOString(), user: currentUser ? currentUser.name : 'system', standards: standardsData, tasks: loadData('tasks', []), assessmentResults: loadData('assessmentResults', {}), assessmentHistory: loadData('assessmentHistory', []), customLaws: loadData('customLaws', []), internalAudits: loadData('internalAudits', []), auditLogs: loadData('auditLogs', []) };
    if (format === 'json') {
...
async function triggerBackup() {
    try {
        const resp = await fetch('/api/backup', { method: 'POST', headers: { 'Authorization': 'Basic ' + btoa('aeo:aeo2026') } });
...
async function showSystemHealth() {
    ...
    try {
        const resp = await fetch('/api/health', { headers: { 'Authorization': 'Basic ' + btoa('aeo:aeo2026') } });
